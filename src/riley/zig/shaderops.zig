...
pub const SpeckleDisk2D = comm.SpeckleDisk2D;
pub const SpeckleList2D = comm.SpeckleList2D;
pub const SpeckleClassificationState = comm.SpeckleClassificationState;
pub const ClassifiedIndexedSpeckle2D = comm.ClassifiedIndexedSpeckle2D;
pub const DirectFixedSpeckleCell2D = comm.DirectFixedSpeckleCell2D;
pub const DirectFixedSpeckle2D = comm.DirectFixedSpeckle2D;
pub const SpeckleMask2D = comm.SpeckleMask2D;
pub const generateSpeckleList2D = comm.generateSpeckleList2D;
pub const generateClassifiedIndexedSpeckle2D = comm.generateClassifiedIndexedSpeckle2D;
pub const generateDirectFixedSpeckle2D = comm.generateDirectFixedSpeckle2D;
pub const generateSpeckleMask2D = comm.generateSpeckleMask2D;
pub const evalSpeckleList2D = comm.evalSpeckleList2D;
pub const evalClassifiedIndexedSpeckle2D = comm.evalClassifiedIndexedSpeckle2D;
pub const evalDirectFixedSpeckle2D = comm.evalDirectFixedSpeckle2D;
pub const evalSpeckleMask2D = comm.evalSpeckleMask2D;
