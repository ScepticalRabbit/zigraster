...
subset_size = 31
ref_img = Path.cwd()/"out"/"bench_images_dicuq"/"cam0_frame0_field0.bmp"
def_img = [Path.cwd()/"out"/"bench_images_dicuq"/"cam0_frame63_field0.bmp",]
...
# Titles
axes[0].set_title('u [px]')
axes[1].set_title('v [px]')
